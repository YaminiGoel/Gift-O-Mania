<%-- 
    Document   : newjsp
    Created on : 2 Nov, 2016, 6:04:03 PM
    Author     : YAMINI
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
         ...
         <c:forEach products="${dbselect.imgsB}" var="imgRows">
             <div class="image">
            <%
            try
            {
                String jstlVar = (String)pageContext.getAttribute("imgRows");  out.println("jstl: " + jstlVar );
